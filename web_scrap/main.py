...
url = 'https://ocandomble.com/os-orixas/ogu/'
...
xpaths = {
    "title": '//*[@id="post-66"]/div[1]/h2/a',
    "img": '//*[@id="post-66"]/div[2]/p[1]/strong/span/a/img',
    "day": '//*[@id="post-66"]/div[2]/p[2]',
    "color": '//*[@id="post-66"]/div[2]/p[3]',
    "symbols": '//*[@id="post-66"]/div[2]/p[4]',
    "element": '//*[@id="post-66"]/div[2]/p[5]',
    "dominance": '//*[@id="post-66"]/div[2]/p[6]',
    "salutes": '//*[@id="post-66"]/div[2]/p[7]'
}
# nana_xpaths = {
...
with open('orixa_info_ogun.json', 'w', encoding='utf-8') as f:
    json.dump(orixa_info_ogun, f, ensure_ascii=False, indent=4)
