...
url = 'https://ocandomble.com/os-orixas/oba/'
...
xpaths = {
    "title": '//*[@id="post-135"]/div[1]/h2/a',
    "img": '//*[@id="post-135"]/div[2]/p[1]/strong/a/img',
...
# with open('orixa_info_nana.json', 'w', encoding='utf-8') as f:
#     json.dump(orixa_info_nana, f, ensure_ascii=False, indent=4)
